...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		<!-- Navbar -->
		<nav style="background-color: #a62184;" class="main-header navbar navbar-expand  navbar-light">
			<!-- Left navbar links -->
			<ul class="navbar-nav">
				<li class="nav-item">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI PELAYANAN ADMINISTRASI DESA</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> SI PEDES</span>
			</a>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				...
				//prem
					case 'prem':
						include "admin/prem/prem.php";
						break;
					 
				//prem
				case 'laki':
					include "admin/laki/laki.php";
					break;
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.instagram.com/y_sukendar56">
					<strong> Yusuf Rizqyulloh Sukendara</strong>
				</a>
				All rights reserved.
			</div>
			<b>SI PEDES VERSI 2021</b>
		</footer>
	...
	<script src="scripts/suket-pdh.js"></script>
